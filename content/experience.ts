...
export const history: HistoryEntry[] = [
  {
    ...
    body: 'A digital transformation services company working in headless CMS strategy, custom web and mobile development, and modern micro-service stacks. Led QA for customer engagements while mentoring junior engineers — lead responsibilities before the formal title arrived with the Contentstack transition.',
  },
  {
